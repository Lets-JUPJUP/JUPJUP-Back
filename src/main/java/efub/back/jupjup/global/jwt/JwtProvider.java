...
import efub.back.jupjup.domain.security.exception.InvalidTokenException;
import efub.back.jupjup.domain.security.exception.InvalidTokenTypeException;
import efub.back.jupjup.domain.security.service.UserDetailsServcieImpl;
import efub.back.jupjup.global.exception.custom.UnAuthorizedException;
...
public class JwtProvider {
	...
	private static final Long accessTokenValidationMs = 15 * 24 * 60 * 60 * 1000L; // 테스트용 15일
