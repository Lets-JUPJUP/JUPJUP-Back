...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
			...
			.orElseGet(() -> {
				if (!memberRepository.existsByEmail(oAuth2UserInfo.getEmail())) {
					...
					return Member.builder()
						...
						.gender(oAuth2UserInfo.getGender() == null ? Gender.NOT_DEFINED :
							Gender.valueOf(oAuth2UserInfo.getGender().toUpperCase().trim()))
	...
	public boolean invalidateNickname(String nickname) {
		if (Objects.isNull(nickname) || nickname.isBlank() || nickname.length() > 15 || !nickname.matches(
			"[ㄱ-ㅎ가-힣a-zA-Z0-9_]+") || nickname.equals(Member.WITHDRAWN_NICKNAME)) {
			return true;
		}
